<template>
    <div>
        ...
        <div class="input-group">
            ...
            <van-button type="warning" size="large"   v-show="show1" round  @click="loginOrRegister">立即登录/注册</van-button>

            <van-button type="info" size="large"   v-show="show1" round  @click="toLoginByPassword">用户名密码登录</van-button>

            <van-button type="warning" size="large"  v-show="show2"  round  @click="loginByPass">登录</van-button>
